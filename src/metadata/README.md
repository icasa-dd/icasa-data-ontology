 ...
 * [icasa.yml](icasa.yml)
     * Determines how your purl.obolibrary.org/obo/icasa/ redirects will be handled
     ...
     * Paste in the contents of [icasa.yml](icasa.yml)
 ...
 * [icasa.md](icasa.md)
     ...
     * Paste in the contents of [icasa.md](icasa.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
